...
def user_login(request):
    if request.method == 'POST':
        ...
        if user:
            ...
            return HttpResponse("<div class='invalid-login' style='margin-top:15rem;margin-left:33rem;width:250px;color:red;text-align:center;padding:4rem;border:1px solid black'>Invalid Login <a href='/login'> Try again</a></div>")
